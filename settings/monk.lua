...
local petSpells = {
	[1] = C_Spell.GetSpellTexture(132578), -- Invoke Niuzao, the Black Ox
	[2] = C_Spell.GetSpellTexture(198664), -- Invoke Chi-Ji, the Red Crane
	[3] = C_Spell.GetSpellTexture(123904), -- Invoke Xuen, the White Tiger
}
...
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(196741)] = { -- Hit Combo
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(124275)] = { -- Light Stagger
		enabled = true,
		alerttype = "DEBUFF",
		enablesound = true,
		sound = "",
	...
	[C_Spell.GetSpellName(124274)] = { -- Moderate Stagger
		enabled = true,
		alerttype = "DEBUFF",
		enablesound = false,
		sound = "",
	...
	[C_Spell.GetSpellName(124273)] = { -- Heavy Stagger
		enabled = true,
		alerttype = "DEBUFF",
		enablesound = false,
		sound = "",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(115178)] = { -- Resuscitate
		enabled = true,
		spellid = 115178,
		announceend = false,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(212051)] = { -- Reawaken
		enabled = true,
		spellid = 212051,
		announceend = false,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(115178) -- Resuscitate
