...
ClassMods.pethealthtexture = C_Spell.GetSpellTexture(31687) -- Summon Water Elemental
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(44544)] = { -- Fingers of Frost
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(190446)] = { -- Brain Freeze
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(80353)] = { -- Time Warp
		enabled = true,
		spellid = 80353,
		announceend = true,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(87023)] = {  -- Cauterize
		enabled = true,
		spellid = 87023,
		announceend = nil,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(130) -- Slow Fall
...
ClassMods.dispelTexture = C_Spell.GetSpellTexture(30449) -- Spellsteal
