...
ClassMods.pethealthtexture = C_Spell.GetSpellTexture(199740) -- Bribe
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(45182)] = { -- Cheat Death (Damage Reduction buff)
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(193359)] = { -- True Bearing (Roll the Bones)
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(57934)] = { -- Tricks of the Trade
		enabled = true,
		spellid = 57934,
		announceend = true,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(45182)] = {  -- Cheat Death
		enabled = true,
		spellid = 45182,
		announceend = false,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(57934) -- Tricks of the Trade
