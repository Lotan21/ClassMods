...
ClassMods.pethealthtexture = C_Spell.GetSpellTexture(63560) -- Dark Transformation
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(101568)] = { -- Dark Succor
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(51124)] = { -- Killing Machine
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(216974)] = { -- Necrosis
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(81340)] = { -- Sudden Doom
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(195181)] = { -- Bone Shield
		enabled = true,
		alerttype = "BUFF",
		enablesound = false,
		sound = "",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(196770)] = { -- Remorseless Winter
		enabled = true,
		spellid = 196770,
		announceend = false,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(61999)] = {  -- Raise Ally
		enabled = true,
		spellid = 61999,
		announceend = true,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(61999) -- Raise Ally
