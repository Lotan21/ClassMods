...
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(54149)] = { -- Infusion of Light
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(183435)] = { -- Retribution
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(209785)] = { -- The Fires of Justice
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(7328)] = { -- Redemption
		enabled = true,
		spellid = 7328,
		announceend = false,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(212056)] = { -- Absolution
		enabled = true,
		spellid = 212056,
		announceend = false,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(633) -- Lay on Hands
