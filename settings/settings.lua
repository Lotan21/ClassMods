...
ClassMods.myVersion = C_AddOns.GetAddOnMetadata( ..., "Version" ):match( "^([aAbBvVrR%d.]+)" )
ClassMods.myVersionRaw = C_AddOns.GetAddOnMetadata( ..., "Version" )
...
ClassMods.spellTracker = CreateFrame("Frame", "CLASSMODS_DURATIONTRACKER",UIParent, "BackdropTemplate")
