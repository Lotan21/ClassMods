...
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(184362)] = { -- Enrage
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(5302)] = { -- Revenge!
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(32216)] = { -- Victory Rush
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(215570)] = { -- Wrecking Ball
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(202573)] = { -- Vengence: Focused Rage
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(202574)] = { -- Vengence: Ignore Pain
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(97462)] = { -- Commanding Shout
		enabled = true,
		spellid = 97462,
		announceend = true,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(198304) -- Intercept (Protection)
