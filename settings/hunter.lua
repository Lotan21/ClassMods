...
ClassMods.ticks = {
	...
	[2] = { -- Marksmanship
		...
		{ true,		185358,			true, false, {1,1,1,1}, 2, false }, -- Arcane Shot
		{ false,	nil,			true, false, {1,1,1,1}, 2, false },
		{ false,	nil,			true, false, {1,1,1,1}, 2, false },
		{ false,	nil,			true, false, {1,1,1,1}, 2, false },
	},
...
ClassMods.classSpells = {
	...
	--	{ 1,		2,	3,}, -- index
		...
		{ 53351, 	10,	2 }, -- Kill Shot
	},
	[2] = { -- Marksmanship
		{ 131894,	20,	2 }, -- A Murder of Crows
		{ 19434,	35,	2 }, -- Aimed Shot
		{ 185358,	20,	2 }, -- Arcane Shot
		{ 257620,	20,	2 }, -- Multi-Shot
		{ 120360,	30,	2 }, -- Barrage
		{ 186387,	10,	2 }, -- Bursting Shot
		{ 271788,	10,	2 }, -- Serpent Sting
		{ 212431,	20,	2 }, -- Explosive Shot
		{ 53351, 	10,	2 }, -- Kill Shot
	},
	[3] = { -- Survival
		{ 131894,	30,	2 }, -- A Murder of Crows
...
ClassMods.pethealthtexture = C_Spell.GetSpellTexture(136) -- Mend Pet
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(194594)] = { -- Lock and Load
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(185791)] = { -- Wild Call
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(34477)] = { -- Misdirection
		enabled = true,
		spellid = 34477,
		announceend = true,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(109248)] = {  -- Binding Shot
		enabled = true,
		spellid = 109248,
		announceend = nil,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(34477) -- Misdirection
