...
ClassMods.pethealthtexture = C_Spell.GetSpellTexture(755) -- Health Funnel
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(205146)] = { -- Demonic Calling
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(171982)] = { -- Grimoire of Synergy
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(20707)] = { -- Soulstone
		enabled = true,
		spellid = 20707,
		announceend = true,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(20707) -- Soulstone
...
ClassMods.dispelTexture = C_Spell.GetSpellTexture(19505) -- Devour Magic
