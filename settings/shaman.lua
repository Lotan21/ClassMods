...
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(108281)] = {	--	Ancestral Guidance
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(215785)] = {	--	Hot Hand
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(77762)] = {	--	Lava Surge
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(201846)] = {	--	Stormbringer
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(216251)] = {	--	Undulation
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
...
ClassMods.announcementDefaults = {
	[C_Spell.GetSpellName(207399)] = {	--	Ancestral Protection Totem
		enabled = true,
		spellid = 207399,
		announceend = false,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(2008)] = {		--	Ancestral Spirit
		enabled = true,
		spellid = 2008,
		announceend = false,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(32182)] = {	--	Heroism
		enabled = true,
		spellid = 32182,
		announceend = true,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(212048)] = {	--	Ancestral Vision
		enabled = true,
		spellid = 212048,
		announceend = false,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(2008) -- Ancestral Spirit
...
ClassMods.dispelTexture = C_Spell.GetSpellTexture(370) -- Purge
