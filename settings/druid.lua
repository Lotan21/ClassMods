...
ClassMods.alertDefaults = {
	...
	[C_Spell.GetSpellName(135700)] = { -- Clear Casting (Feral)
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(16870)] = { -- Clear Casting (Restoration)
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
	...
	[C_Spell.GetSpellName(93622)] = { -- Mangle! (Guardian)
		enabled = true,
		alerttype = "BUFF",
		enablesound = true,
		sound = "Ding",
...
ClassMods.announcementDefaults = {
	...
	[C_Spell.GetSpellName(20484)] = {  -- Rebirth
		enabled = true,
		spellid = 20484,
		announceend = nil,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(77764)] = {  -- Stampeding Roar (Feral)
		enabled = true,
		spellid = 77764,
		announceend = nil,
		solochan = "AUTO",
	...
	[C_Spell.GetSpellName(77761)] = {  -- Stampeding Roar (Guardian)
		enabled = true,
		spellid = 77761,
		announceend = nil,
		solochan = "AUTO",
...
ClassMods.clickToCastDefault = C_Spell.GetSpellName(29166) -- Innervate
