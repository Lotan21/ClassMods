					...
					activestack = {
						...
						values = function()
							...
							for i=1,#ClassMods.stacks[playerSpec] do
								t[i] = C_Spell.GetSpellName(ClassMods.stacks[playerSpec][i][2])
						...
						set = function(info, value)
							...
							for i=1,#DB.resourcebar.stacks[playerSpec] do
								if C_Spell.GetSpellName(DB.resourcebar.stacks[playerSpec][i][2]) == t[value] then
							...
							spell1 = {
								...
								values = function()
									...
									for i=1,#ClassMods.classSpells[playerSpec] do
										t[i] = C_Spell.GetSpellName(ClassMods.classSpells[playerSpec][i][1])
										if (t[i] == C_Spell.GetSpellName(DB.resourcebar.ticks[playerSpec][1][2])) then
						...
						args = {
							...
							spell2 = {
								...
								values = function()
									...
									for i=1,#ClassMods.classSpells[playerSpec] do
										t[i] = C_Spell.GetSpellName(ClassMods.classSpells[playerSpec][i][1])
										if (t[i] == C_Spell.GetSpellName(DB.resourcebar.ticks[playerSpec][2][2])) then
						...
						args = {
							...
							spell3 = {
								...
								values = function()
									...
									for i=1,#ClassMods.classSpells[playerSpec] do
										t[i] = C_Spell.GetSpellName(ClassMods.classSpells[playerSpec][i][1])
										if (t[i] == C_Spell.GetSpellName(DB.resourcebar.ticks[playerSpec][3][2])) then
						...
						args = {
							...
							spell4 = {
								...
								values = function()
									...
									for i=1,#ClassMods.classSpells[playerSpec] do
										t[i] = C_Spell.GetSpellName(ClassMods.classSpells[playerSpec][i][1])
										if (t[i] == C_Spell.GetSpellName(DB.resourcebar.ticks[playerSpec][4][2])) then
						...
						args = {
							...
							spell5 = {
								...
								values = function()
									...
									for i=1,#ClassMods.classSpells[playerSpec] do
										t[i] = C_Spell.GetSpellName(ClassMods.classSpells[playerSpec][i][1])
										if (t[i] == C_Spell.GetSpellName(DB.resourcebar.ticks[playerSpec][5][2])) then
