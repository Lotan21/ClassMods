		...
		args = {
			...
			spell = { -- Spell name or ID.
				...
				validate = function(info, val)
					if C_Spell.GetSpellInfo(tonumber(val) and tonumber(val) or tonumber(val.match(val, "spell:(%d+)")) or val) then return(true) end
				...
				set = function(info, val)
					DB.clicktocast[info[#info] ] = C_Spell.GetSpellName(tonumber(val) and tonumber(val) or tonumber(val.match(val, "spell:(%d+)")) or val)
