...
function ClassMods.UnlockAllMovers()
	...
	for i=1,#movers do
		...
		Mixin(movers[i][moverFrame], BackdropTemplateMixin)
		...
		movers[i][moverFrame].value = movers[i][moverFrame].value or movers[i][moverFrame]:CreateFontString(nil, "OVERLAY", nil)
