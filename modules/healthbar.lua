...
function ClassMods.SetupHealthBar()
	...
	if ClassMods.db.profile.healthbar.enabled then
		...
		ClassMods.F.HealthBar:SetStatusBarColor(unpack(ClassMods.db.profile.healthbar.barcolor) )
		...
		if ClassMods.db.profile.healthbar.pethealthbar then
			...
			ClassMods.F.HealthBar.petHealthFrame = ClassMods.F.HealthBar.petHealthFrame or CreateFrame("StatusBar", nil, ClassMods.F.HealthBar, "BackdropTemplate")
		...
		if ClassMods.db.profile.healthbar.incomingheals then
			ClassMods.F.HealthBar.IncomingHeals = ClassMods.F.HealthBar.IncomingHeals or CreateFrame("StatusBar", nil, ClassMods.F.HealthBar, "BackdropTemplate")
		...
		-- Setup absorbs bar
		if ClassMods.db.profile.healthbar.incomingheals then
			ClassMods.F.HealthBar.Absorbs = ClassMods.F.HealthBar.Absorbs or CreateFrame("StatusBar", nil, ClassMods.F.HealthBar, "BackdropTemplate")
