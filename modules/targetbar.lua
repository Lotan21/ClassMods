...
function ClassMods.SetupTargetBar()
	...
	if ClassMods.db.profile.targetbar.enabled then
		...
		if ClassMods.db.profile.targetbar.incomingheals then
			ClassMods.F.TargetBar.IncomingHeals = ClassMods.F.TargetBar.IncomingHeals or CreateFrame("StatusBar", nil, ClassMods.F.TargetBar, "BackdropTemplate")
		...
		-- Setup absorbs bar
		if ClassMods.db.profile.targetbar.incomingheals then
			ClassMods.F.TargetBar.Absorbs = ClassMods.F.TargetBar.Absorbs or CreateFrame("StatusBar", nil, ClassMods.F.TargetBar, "BackdropTemplate")
		...
		if ClassMods.db.profile.targetbar.resource then
			...
			ClassMods.F.TargetBar.powerFrame = ClassMods.F.TargetBar.powerFrame or CreateFrame("StatusBar", nil, ClassMods.F.TargetBar, "BackdropTemplate")
		...
		ClassMods.F.TargetBar:RegisterUnitEvent("UNIT_HEALTH", "target")
