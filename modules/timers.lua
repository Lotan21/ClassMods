...
local function SetupTimers(parent, setsName, stationary)
	...
	for i=1,#ClassMods.db.profile.timers[setsName].timers do
		...
		if 	( 	(ClassMods.db.profile.timers[setsName].timers[i][9] ~= true) or  -- Not only if known check
			...
			parent.Timers[index].agparent = parent.Timers[index].agparent or CreateFrame("Frame", nil, parent.Timers[index], "BackdropTemplate")
			...
			if (ClassMods.db.profile.timers[setsName].timers[i][7] ~= "NONE") then
				...
				parent.Timers[index].fntparent = parent.Timers[index].fntparent or CreateFrame("Frame", nil, parent.Timers[index], "BackdropTemplate")
				...
				elseif (ClassMods.db.profile.timers[setsName].timers[i][7] == "LEFT") then
					...
					parent.Timers[index].fntparent.value:SetJustifyV("MIDDLE")
			...
			parent.Timers[index].stacksparent = parent.Timers[index].stacksparent or CreateFrame("Frame", nil, parent.Timers[index], "BackdropTemplate")
			...
			parent.Timers[index].stacksparent.stacks:SetTextColor(unpack(ClassMods.db.profile.timers[setsName].stackfontcolor))
